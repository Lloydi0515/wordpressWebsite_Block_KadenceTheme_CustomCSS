...
return array(
	'title'      => esc_html__( '404', 'block' ),
	'categories' => array( 'text' ),
	'inserter'   => false,
	'content'    => '
		<!-- wp:heading {"textAlign":"center","fontSize":"x-large"} -->
		<h2 class="has-text-align-center has-x-large-font-size">' . __( 'Page not found', 'block' ) . '</h2>
		<!-- /wp:heading -->
		<!-- wp:paragraph --><p>' . __( 'It looks like nothing was found at this location. Maybe try a search?', 'block' ) . '</p><!-- /wp:paragraph -->
		...
		<h2 class="has-text-align-left">' . __( 'Latest posts', 'block' ) . '</h2>
		<!-- /wp:heading -->
